...
pub enum ExportAction {
    ...
    /// the stored credentials; it does NOT scrub the ones captured inside
    ...
    Session {
        ...
        /// requests and responses (Authorization / Cookie headers, login
        /// bodies) stay in the bundle — see the command help.
        #[arg(long)]
        redact: bool,
